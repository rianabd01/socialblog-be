...
type User struct {
	...
	Password   string          `gorm:"size:255;" json:"-" validate:"omitempty,min=8"`
	Provider   string          `gorm:"size:255;" json:"provider" validate:"omitempty,oneof=google facebook"`
	ProviderID string          `gorm:"size:255;uniqueIndex:idx_provider_id" json:"provider_id" validate:"omitempty,min=1"`
